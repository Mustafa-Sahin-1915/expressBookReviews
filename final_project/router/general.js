...
public_users.post("/register", (req,res) => {
    ...
    if(isValid(username)) {
        ...
        return res.status(404).json({message: "please enter the unique username "});
    }
}
else {
  return res.status(404).json({message: "please enter the username or password completely"});
}
